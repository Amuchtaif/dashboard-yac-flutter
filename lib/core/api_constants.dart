...
class ApiConstants {
  ...
  static const String teacherTeachingInfo =
      '${baseUrl}teacher/get_my_teaching_info.php';
  ...
  static String? getWorkReportPhotoUrl(String? filename) {
    if (filename == null || filename.isEmpty || filename == 'null') return null;
    if (filename.startsWith('http')) return filename;
    final rootUrl = ApiConfig.baseUrl.replaceAll('/api', '');
    return "$rootUrl/uploads/work_reports/$filename";
  }
  ...
  static const String tahfidzGetMyStudents =
      '${baseUrl}tahfidz/get_my_students.php';
  static const String tahfidzAddMember =
